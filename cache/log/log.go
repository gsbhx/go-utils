...
type Logger struct {
	...
	DetailLogger *loggerObject
	grabPlanListInfo *loggerObject
}
...
func (this *Logger) InitLogger(dir string) (e error) {
	...
	if err != nil {
		...
		this.DetailLogger =new(loggerObject)
		this.grabPlanListInfo =new(loggerObject)
		...
		makeLoggerObj(this.DetailLogger, "DETAIL")
		makeLoggerObj(this.grabPlanListInfo, "GRABPLANLISTINFO")
	}
	return
}
...
func (this *Logger) Detail(format string, args ...interface{}) {
	if level <= DETAIL {
		this.DetailLogger.write("DETAIL", format, args...)
	}
}

func (this *Logger) GrabPlanListInfo(format string, args ...interface{}) {
	if level <= DETAIL {
		this.grabPlanListInfo.write("GRABPLANLISTINFO", format, args...)
	}
}

func (this *Logger) DataLog(format string, args ...interface{}) {
	this.infoLogger.write("DATA", format, args...)
}
